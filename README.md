...
![Type Check](https://github.com/pchynoweth/svelte-share-buttons-component/workflows/Type%20Check/badge.svg)
...
```html
<script>
	import { Bluesky, Discord, Email, HackerNews, Mastodon, Reddit, LinkedIn, Pinterest, SMS, Telegram, Threads, Tumblr, Vk, WebShare, WhatsApp, Xing, Facebook, X, Line } from 'svelte-share-buttons-component';
...
<SMS class="share-button" text="{title} {url}" />
<Telegram class="share-button" text={title} {url} />
<Threads class="share-button" text="{title}" {url} />
