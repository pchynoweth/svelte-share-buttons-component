<script>
	...
	import { Bluesky, Discord, Email, HackerNews, Mastodon, Reddit, LinkedIn, Pinterest, SMS, Telegram, Tumblr, Vk, WebShare, WhatsApp, Xing, Facebook, X, Line, Viber } from '../src/index.ts';
