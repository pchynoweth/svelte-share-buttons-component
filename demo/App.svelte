<script>
	...
	import { Email, HackerNews, Reddit, LinkedIn, Pinterest, Telegram, Tumblr, Vk, WhatsApp, Xing, Facebook, Twitter, Line, Viber } from 'svelte-share-buttons-component/src';
